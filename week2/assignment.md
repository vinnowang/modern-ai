...
1. Create a Cursor account: https://cursor.com
2. Download Cursor Desktop and/or Terminal : https://cursor.com/download
3. Navigate to the project and run `agent`
...
```
2. From the project root (the modern-ai folder), run the server:
```
...
As you work through the assignment, use `writeup.md` to document your progress. Be sure to include the prompts you use, as well as any changes made by you or Cursor. Please also include comments throughout your code to document your changes. 
